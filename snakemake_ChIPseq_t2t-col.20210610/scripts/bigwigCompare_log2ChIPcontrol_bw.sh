...
# Usage:
# csmit -m 50G -c 48 "bash ./bigwigCompare_log2ChIPcontrol_bw.sh WT_H3K9me2_Rep1_ChIP WT_H3K9me2_Rep1_input 100000 100kb 48"
...
bigwigCompare -b1 "../mapped/both/bw/"${ChIPName}"_MappedOn_t2t-col.20210610_lowXM_both_sort_norm.bw" \
              -b2 "../mapped/both/bw/"${controlName}"_MappedOn_t2t-col.20210610_lowXM_both_sort_norm.bw" \
